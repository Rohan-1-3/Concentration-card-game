    ...
    <div className='main-container text-center py-10'>
      {startGame ? (
        ...
        <footer className="fixed bottom-0 left-0 z-20 w-full p-4 bg-white border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://github.com/Rohan-1-3/Concentration-card-game" className="hover:underline text-blue-500">Rohan-1-3</a>. All Rights Reserved.
            </span>
          </footer>
    </div>
